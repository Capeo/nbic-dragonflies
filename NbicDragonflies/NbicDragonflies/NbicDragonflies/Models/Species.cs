...
namespace NbicDragonflies.Models {
    public class Species {
        ...
        private void CreatePlaceholderSpecies() {
            TopImage = new SpeciesImage("dragonfly1.jpg", "Phrida Norrhall", "12/3-14", "LC4400");
            ...
            Images = new List<SpeciesImage> { new SpeciesImage("dragonfly2.jpg", "Phrida Norrhall", "12/3-14", "LC4400"), new SpeciesImage("dragonfly2.jpg", "Phrida Norrhall", "12/3-14", "LC4400") };
        }
    }
}
