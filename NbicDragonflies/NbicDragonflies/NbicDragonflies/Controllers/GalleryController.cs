	...
	public class GalleryController : IGalleryController {
		...
		public List<ImageElement> GetGalleryImages()
		{
			...
			List<ImageElement> list = new List<ImageElement> {
				...
				new ImageElement("dragonfly1.jpg", "Brun øyenstikker", "Phrida Norrhall", "12.03.2014", "LC4400", "Description", new List<Taxon> { t }),
				new ImageElement("dragonfly7.png", "Brun øyenstikker", "Phrida Norrhall", "12.03.2014", "LC4400", "Description", new List<Taxon> { t }),
				new ImageElement("dragonfly6.png", "Høstøyenstikker", "Phrida Norrhall", "12.03.2014", "LC4400", "Description", new List<Taxon> { t }),
				new ImageElement("dragonfly9.png", "Vanlig øyenstikker", "Phrida Norrhall", "12.03.2014", "LC4400", "Description", new List<Taxon> { t }),
					new ImageElement("dragonfly5.png", "Rødbrun høstlibelle", "Daniel Groos", "12.03.2014", "LC4400", "Description", new List<Taxon> { t }),
